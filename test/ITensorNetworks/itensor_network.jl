...
using ITensorNetworkAD.ITensorNetworks: itensor_network, neighbors
...
@testset "itensor_network.jl" begin
  @testset "itensor_network from dims" begin
    ...
    @test issetequal(neighbors(tn, CartesianIndex(1, 2)), [CartesianIndex(1, 1), CartesianIndex(2, 2), CartesianIndex(3, 2), CartesianIndex(1, 3)])
  end
